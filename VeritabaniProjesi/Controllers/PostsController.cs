...
namespace VeritabaniProjesi.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostId,Sender,Content,Rating,Date")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken, Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostId,Sender,Content,Rating,Date")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
